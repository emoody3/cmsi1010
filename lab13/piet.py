...
pygame.init()
# close it with command +Q
WIDTH, HEIGHT = 800, 600
screen = pygame.display.set_mode((WIDTH, HEIGHT))

# below is how to make the screen full screen
...
COLORS = [
    ...
    pygame.Color("blue"),
    pygame.Color("yellow"),
    # pygame has built in colors for you to use so you dont necessarily have to define your own RGB values
]
