...
background_color = (100, 140, 250)
leaf_color = (220, 243, 255)
trunk_width = 40
base_trunk_color = (160, 35, 59)
small_branch_color = (240, 225, 48)
branch_gradient = (*base_trunk_color, *small_branch_color)

trunk_length = 250
first_branch_line = (0, 0, 0, -trunk_length)
scales_and_angles = [(0.7, radians(50)), (0.7, radians(-30))]
age = 11
